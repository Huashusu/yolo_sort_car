...
mot_tracker = Sort(max_age=60, min_hits=6)


# import glob
# files=glob.glob('logs/youshang/Epoch*.pth')
...
class YOLO(object):
    _defaults = {
        ...
        # 'model_data/yolo4_voc_weights.pth',#'logs/dawei/Epoch5-Total_Loss11.6855-Val_Loss7.6718.pth1',
    ...
    def generate(self):
        ...
        # 加快模型训练的效率
        print('Loading weights into state dict...', self.model_path)
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf',
                                  size=np.floor(3e-2 * np.shape(image)[1] * 0.5 + 0.5).astype('int32'))
